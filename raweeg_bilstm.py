...
np.save('raweeg_data.npy', data_array)
# Load the saved stacked_array
np.save('raweeg_label.npy', label_array)

# Load the saved stacked_array
data_array = np.load('raweeg_data.npy')
# Load the saved stacked_array
label_array = np.load('raweeg_label.npy')
...
with open('bilstm_training_history_raw.json', 'w') as json_file:
    json.dump(history.history, json_file)

model.save('bilstm_raw')

model = tf.keras.models.load_model('bilstm_raw')
...
with open('bilstm_training_history_raw.json', 'r') as json_file:
